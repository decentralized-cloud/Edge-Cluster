...
func (service *mongodbRepositoryService) CreateEdgeCluster(
	...
	if err != nil {
		return nil, commonErrors.NewUnknownErrorWithError("failed to create edge cluster.", err)
	}
...
func (service *mongodbRepositoryService) ReadEdgeCluster(
	...
	if err == mongo.ErrNoDocuments {
		...
		return nil, commonErrors.NewUnknownErrorWithError("failed to retrieve edge cluster", err)
	}
...
func (service *mongodbRepositoryService) UpdateEdgeCluster(
	...
	if err != nil {
		return nil, commonErrors.NewUnknownErrorWithError("failed to update edge cluster.", err)
	}
...
func (service *mongodbRepositoryService) DeleteEdgeCluster(
	...
	if err != nil {
		return nil, commonErrors.NewUnknownErrorWithError("failed to delete edge cluster.", err)
	}
...
func (service *mongodbRepositoryService) ListEdgeClusters(
	ctx context.Context,
	request *repository.ListEdgeClustersRequest) (*repository.ListEdgeClustersResponse, error) {
	response := &repository.ListEdgeClustersResponse{
